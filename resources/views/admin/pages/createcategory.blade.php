                ...
                <div class="col-md-12">
                    ...
                    <section class="tile">
                        ...
                        <div class="tile-body">
                            ...
                            @endif
                            <form class="form-horizontal" role="form" action={{ route('admin.postCreateCategory') }}  method="POST">
                                @csrf
                                <div class="form-group">
                                    <label for="input01" class="col-sm-2 control-label">Tên</label>
                                    <div class="col-sm-10 col-md-5">
                                        <input type="text" class="form-control" name="txtTen" id="input01">
                                    </div>
                                </div>
