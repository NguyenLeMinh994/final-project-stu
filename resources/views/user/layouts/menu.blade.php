<div class="collapse navbar-collapse" id="ftco-nav">
  <ul class="navbar-nav ml-auto">
    ...
    <li class="nav-item cta">
      <a href="{{  Auth::user()->quyen==1?route('user.home'):route('admin.home') }}"
        class="nav-link">{{ Auth::user()->hoten }}
      </a>
    </li>
    @else
    <li class="nav-item cta"><a href={{ route('login') }} class="nav-link ml-lg-2"><span class="icon-user"></span> Đăng
        nhập</a></li>
    <li class="nav-item cta cta-colored"><a href={{ route('signup') }} class="nav-link"><span
          class="icon-pencil"></span> Đăng ký</a></li>
    @endif
