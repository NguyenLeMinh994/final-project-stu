    ...
    <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
            <div class="col-md-9 ftco-animate text-center">
                <p class="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span class="mr-2"><a href="{{ route('home') }}">Trang chủ</a></span> <span class="mr-2"></span>     <span>Chi tiết</span></p>
                ...
                <div class="row">
                    <div class="col-md-12 ftco-animate">
                        <div class="single-slider owl-carousel">
                            ...
                            <div class="item">
                                <div class="properties-img" style="background-image: url(asset/user/images/{{$hinh->link}});">
                                </div>
                            </div>
                            @endforeach
                        </div>
                    ...
                    <div class="col-md-12 Properties-single mt-4 mb-5 ftco-animate">
                        ...
                        <p class="rate mb-4">
                            <span class="loc"><a href="#"><i class="icon-map"></i> {{$getDetail->diachi}} - {{$getDetail->getQuan->ten}} - {{$getDetail->getTinhThanhPho->ten}}</a></span>
                        </p>
            ...
            <div class="col-lg-4 sidebar ftco-animate">
                ...
                <div class="sidebar-box ftco-animate">
                    ...
                    <div class="block-21 mb-4 d-flex">
                        ...
                        <div class="text">
                            <h3 class="ten4"><a href="#"><h6>{{catchuoi($sp_k->ten)}}</h6></a></h3>
                            <div class="meta">
