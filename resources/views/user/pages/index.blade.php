    ...
    <div class="row justify-content-center mb-5 pb-3">
      <div class="col-md-7 heading-section text-center ftco-animate">
        ...
        <ul class="nav nav-tabs pgl-pro-tabs text-center animation" role="tablist">
          <li class="active"><a href="#all" role="tab" data-toggle="tab">Ngang</a></li> | <li><a href="#house"
              role="tab" data-toggle="tab">Dọc</a></li>
        </ul>
      </div>
    </div>
  </div>
            ...
            <div class="row no-gutters">
              ...
              <div class="col-md-8">
                <div class="card-body">
                  ...
                  <p class="card-text">{!! str_limit($post->noidung, $limit = 20, $end = '...') !!}</p>
                  <p class="card-text"><i class="icon-my_location"></i> {{$post->diachi}}, {{$post->getQuan->ten}},
